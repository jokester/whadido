...
const text_1 = require("../common/io/text");
...
class ObjReader {
    ...
    readMetaData(firstChunk) {
        const maybeMetadata = text_1.chunkToLines(firstChunk);
        // first non-empty line
        const metadataLine = maybeMetadata.find(l => !!l);
        if (!metadataLine) {
            throw new GitRepoException(`metadata not found: ${JSON.stringify(firstChunk)} / ${JSON.stringify(text_1.chunkToLines(firstChunk))}`);
        }
...
class GitRepoImpl {
    ...
    listRefs() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const concated = ([yield localHead]).concat(yield unpacked).concat(yield packed);
    ...
    readUnpackedRefs() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const refFiles = yield util_2.recursiveReadDir(start);
            const found = [];
    ...
    readObject(sha1) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            switch (objRaw.type) {
                case 1 /* COMMIT */:
                    return parser.parseCommit(objRaw.sha1, text_1.chunkToLines(objRaw.data));
                case 2 /* ATAG */:
                    return parser.parseAnnotatedTag(objRaw.sha1, text_1.chunkToLines(objRaw.data));
                case 4 /* BLOB */:
                case 3 /* TREE */:
...
exports.GitRepoImpl = GitRepoImpl;
