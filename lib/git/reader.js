...
function readHead(repo, refname) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (!l0)
            ...
            return new git_types_1.GitBareHead(refname, l0);
        }
        else {
            const branch_name = parser.extractRef(l0);
            return new git_types_1.GitHead(refname, branch_name);
        }
    });
}
...
function readRefs(repo) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        for (const r of refNames) {
            if (r.type === git_types_1.RefType.TAG) {
                refs.push(yield readTag(repo, r.name));
            }
            else if (r.type === git_types_1.RefType.HEAD) {
                refs.push(yield readHead(repo, r.name));
            }
            else if (r.type === git_types_1.RefType.BRANCH) {
