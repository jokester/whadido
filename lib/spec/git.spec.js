...
describe("git reader", () => {
    ...
    it("reads all refs", () => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        expect(refs.length).toEqual(/*local head*/ 1 + expectedUnpackedRefs.length + 8);
    }));
    it("reads object: commit", () => tslib_1.__awaiter(this, void 0, void 0, function* () {
        const o = yield r.readObject("931bbc96");
        expect(o.type).toEqual(1 /* COMMIT */);
    ...
    it("reads object: annotated tag", () => tslib_1.__awaiter(this, void 0, void 0, function* () {
        const o = yield r.readObject("07fc");
        expect(o.sha1).toEqual("07fc5636f0359a857a5f9ecd583fcd56d6edb83b");
        expect(o.type).toEqual(2 /* ATAG */);
        if (gittypes.Obj.isAnnotatedTag(o)) {
            expect(o.destType).toEqual(1 /* COMMIT */);
    ...
    it("resolves ref: shallow tag", () => tslib_1.__awaiter(this, void 0, void 0, function* () {
        const tag = yield r.getRefByPath("refs/tags/shallow-tag");
        const resolved = yield r.resolveRef(tag);
    ...
    it("resolves ref: annotated tag", () => tslib_1.__awaiter(this, void 0, void 0, function* () {
        const tag = yield r.getRefByPath("refs/tags/v0.3.2");
        const resolved = yield r.resolveRef(tag);
        ...
        expect(resolved.destType).toEqual(1 /* COMMIT */);
    }));
    it("reads reflog: HEAD", () => tslib_1.__awaiter(this, void 0, void 0, function* () {
        const reflog = yield r.readReflog("HEAD");
    ...
    it("reads reflog: non-exist", () => tslib_1.__awaiter(this, void 0, void 0, function* () {
        const reflog = yield r.readReflog("empty");
        expect(reflog.length).toEqual(0);
    }));
    it("resolves annotated tag to commit", () => tslib_1.__awaiter(this, void 0, void 0, function* () {
        const ref = yield r.getRefByPath("refs/tags/v0.3.2");
        const tag = yield r.resolveRef(ref);
        expect(tag.destObj).toEqual("414c5870b27970db0fa7762148adb89eb07f1fe0");
        const last = yield r.resolveTag(tag);
        expect(last.type).toEqual(1 /* COMMIT */);
        expect(last.sha1).toEqual("414c5870b27970db0fa7762148adb89eb07f1fe0");
    }));
    it("resolves (nested) annotated tag to commit", () => tslib_1.__awaiter(this, void 0, void 0, function* () {
        const ref = yield r.getRefByPath("refs/tags/nested-atag");
        const tag = yield r.resolveRef(ref);
    ...
    it("resolves annotated tag to blob", () => tslib_1.__awaiter(this, void 0, void 0, function* () {
        const ref = yield r.getRefByPath("refs/tags/atag-to-blob");
        const tag = yield r.resolveRef(ref);
        expect(tag.destObj).toEqual("0e25bed4707ad850bde6b7dc6ea94c30714c087b");
        const last = yield r.resolveTag(tag);
        expect(last.type).toEqual(4 /* BLOB */);
        expect(last.sha1).toEqual("0e25bed4707ad850bde6b7dc6ea94c30714c087b");
    }));
    it("resolved shallow-tag to commit", () => tslib_1.__awaiter(this, void 0, void 0, function* () {
        const ref = yield r.getRefByPath("refs/tags/shallow-tag");
        const tag = yield r.resolveRef(ref);
