...
let TestGitRepo = class TestGitRepo {
    ...
    readObjRaw2() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const testRepo = yield this.openTestRepo();
            const rawObj2 = yield testRepo.readObjRaw("HEAD");
            chai_1.expect(rawObj2.length).eq(10);
            // expect(rawObj2[0]).eq("414c5870b27970db0fa7762148adb89eb07f1fe0 commit 347");
            chai_1.expect(rawObj2[3]).eq("committer Martin von Gagern <Martin.vGagern@gmx.net> 1478766514 +0100");
            chai_1.expect(rawObj2[7]).eq("This line got into master by accident, as gulp support isn't ready yet.");
        });
    }
};
tslib_1.__decorate([
