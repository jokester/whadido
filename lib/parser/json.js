...
const str = text_1.seq3(text_1.skipWhitespace(text_1.charLit("\"")), text_1.reiterate(text_1.filter(text_1.getChar, c => c !== "\"")), text_1.charLit("\""), (a, b, c) => text_1.unit({ raw: b.join(""), type: TokenType.str }));
const eof = text_1.bind(text_1.skipWhitespace(text_1.eof), _ => text_1.unit({ type: TokenType.eof, raw: "" }));
exports.token = text_1.seq2(text_1.reiterate(text_1.or(lp, rp, comma, lb, rb, num, str)), eof, (tokens, _) => text_1.zero);
