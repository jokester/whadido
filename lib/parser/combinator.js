...
exports.seq2 = (p1, p2, then) => {
    return exports.bind(p1, a => exports.bind(p2, b => exports.unit(then(a, b))));
};
exports.seq3 = (p1, p2, p3, then) => {
    return exports.bind(p1, a => exports.bind(p2, b => exports.bind(p3, c => exports.unit(then(a, b, c)))));
};
